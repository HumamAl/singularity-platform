...
One thing I want to get right: is the Vault content gated per user tier or does Firebase auth handle it through custom claims?

Quick call to align on scope, or I can draft the first milestone?

Humam

P.S. Happy to record a quick Loom walkthrough of the demo if that's easier than clicking around.
